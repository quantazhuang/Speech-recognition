...
import name.swyan.speechcalculator.mfcc.Delta;
import name.swyan.speechcalculator.mfcc.Energy;
import name.swyan.speechcalculator.mfcc.FeatureVector;
import name.swyan.speechcalculator.mfcc.MFCC;
...
public class Extract {
	 ...
	 */
	public Extract(float[][] framedSignal, int samplingRate, int samplePerFrame) {
